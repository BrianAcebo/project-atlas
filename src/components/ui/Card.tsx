...
export const Card = ({
  ...
  return (
    ...
    >
      ...
      <div className="from-brand-blue-dark bg-brand-blue-dark pointer-events-none absolute right-0 -bottom-[2px] left-0 z-20 h-5 rounded-br-2xl rounded-bl-2xl bg-gradient-to-t via-transparent to-transparent" />
