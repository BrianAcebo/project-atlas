        ...
        <div className="flex flex-col gap-10 md:gap-24">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <Card className="mx-auto w-full max-w-xl px-8 py-6 md:px-12 md:py-10">
              ...
              <p className="mb-5 text-sm">Internal linking is one of the most overlooked aspects of SEO — but not anymore. Project Atlas analyzes your topical relationships and makes smart recommendations for internal links that strengthen your site architecture and boost page authority.</p>
          ...
          <Card id="signup" className="mx-auto w-full max-w-xl px-8 py-6 md:max-w-none md:px-12 md:py-16">
            <hgroup className="mx-auto max-w-3xl">
              ...
              <p className="mx-auto mb-6 max-w-3xl text-center text-sm md:px-4 md:text-lg">Whether you're scaling a blog, running an agency, or leading an SEO team, Project Atlas gives you the clarity, control, and strategic edge you need to grow your organic reach. Sign up today and start building real topical authority with a system that scales with you.</p>
            </hgroup>
